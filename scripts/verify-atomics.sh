...
artifacts = [
    ...
    hash_existing("crates/residiuum-store/src/atomic_range_index.rs"),
    hash_existing("crates/residiuum-store/src/atomic_stage_classify.rs"),
    hash_existing("crates/residiuum-store/src/atomic_stage_status.rs"),
