...
pub use heap::{
    ...
    classify_mixed_heap_frame, collection_create_binding, create_object, decode_purge_receipt,
    ...
    rebuild_object_entry_from_chain_strict, record_admin_op_dedup,
    ...
    resolve_admin_op_dedup, restore_payload_to_new_heap, retire_heap, retire_object,
